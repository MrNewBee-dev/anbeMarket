...
namespace Anbe.Areas.AnbeAdmin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(AnbeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CategoryID,CategoryName,ParentCategoryID")] Category category1)
        {
            ...
            ViewData["ParentCategoryID"] = new SelectList(_context.Categories, "CategoryID", "CategoryName", category1.ParentCategoryID);
